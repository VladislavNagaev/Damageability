...
def _damageability(
    ...
    return dict(
        _values=values,
        _smoothing_value=smoothing_value,
        _fcd=fcd,
        _extremum_indexes=extremum_indexes,
        _start_cycle_indexes=start_cycle_indexes,
        _end_cycle_indexes=end_cycle_indexes,
        _zero_cycles_positive=zero_cycles_positive,
        _zero_cycles_negative=zero_cycles_negative,
        _damageability_array_positive=damageability_array_positive,
        _damageability_array_negative=damageability_array_negative,
    )
