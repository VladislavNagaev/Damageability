...
class Damageability:
    ...
    def __init__(
        self,
        _values:NDArray, 
        _smoothing_value:float,
        _fcd:float,
        _extremum_indexes:NDArray,
        _start_cycle_indexes:NDArray,
        _end_cycle_indexes:NDArray,
        _zero_cycles_positive:NDArray,
        _zero_cycles_negative:NDArray,
        _damageability_array_positive:NDArray,
        _damageability_array_negative:NDArray,
        **kwargs,
    ) -> None:
        
        # Инициализация параметров
        self._values = _values
        self._smoothing_value = _smoothing_value
        self._fcd = _fcd
        self._extremum_indexes = _extremum_indexes
        self._start_cycle_indexes = _start_cycle_indexes
        self._end_cycle_indexes = _end_cycle_indexes
        self._zero_cycles_positive = _zero_cycles_positive
        self._zero_cycles_negative = _zero_cycles_negative
        self._damageability_array_positive = _damageability_array_positive
        self._damageability_array_negative = _damageability_array_negative
